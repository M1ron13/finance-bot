...
# Триггер-слова — постим ВСЕГДА с пометкой СРОЧНО
URGENT_WORDS = [
    "ставка", "нбрк", "тенге", "девальвация", "дефолт",
    "инфляция", "санкции", "обвал", "кризис", "экстренн",
    "повысил", "снизил", "доллар", "нефть", "биткоин",
    "выпуск", "уран", "золото", "валюта", "экономика",
    "риск", "курс", "доходность", "облигации", "акции",
    "фьючерсы", "дивиденды", "погашения", "политика",
    "etf", "биржа", "aix", "криптовалюта", "стейблкоин",
    "kase", "ии", "ai", "ставка фрс", "фрс",
]
 
# Спам-слова — эти посты ВСЕГДА пропускаем
SPAM_WORDS = [
    ...
    "скидка", "акция", "купить", "продать сейчас",
    "только сегодня", "успей", "ограниченное предложение",
    "бесплатно", "заработай", "пассивный доход",
...
async def main():
    ...
    async def handler(event):
        ...
        # Похожая новость (только если не срочная)
